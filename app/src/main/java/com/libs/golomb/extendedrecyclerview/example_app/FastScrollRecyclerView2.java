...
public class FastScrollRecyclerView2 extends RecyclerView implements RecyclerView.OnItemTouchListener {
    ...
    public String scrollToPositionAtProgress(float touchFraction) {
        ...
        layoutManager.scrollToPositionWithOffset((int)itemPos ,//* exactItemPos / mScrollPosState.rowHeight,
                -(exactItemPos % mScrollPosState.rowHeight));

        if (!(getAdapter() instanceof com.simplecityapps.recyclerview_fastscroll.views.FastScrollRecyclerView.SectionedAdapter)) {
            return "";
        }
