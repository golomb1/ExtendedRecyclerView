...
public class FastScroller2 {
    ...
    private FastScrollRecyclerView2 mRecyclerView;
    private FastScrollPopup2 mPopup;
    ...
    public AtomicInteger scrollY = new AtomicInteger(0);
    private int mTouchOffsetB;
        ...
        mHideRunnable = new Runnable() {
            ...
            public void run() {
                if (!mIsDragging) {
                    ...
                    mAutoHideAnimator = ObjectAnimator.ofInt(FastScroller2.this, "offsetX", (Utils.isRtl(mRecyclerView.getResources()) ? -1 : 1) * mWidth);
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsDragging) {
                    ...
                    Log.d("LOG", "offset: " + (((mTouchOffsetB + lastY) * mRecyclerView.getAvailableYScrolling()) / (mRecyclerView.getHeight())));
    ...
    public int getHeight(){
        return (mRecyclerView.getHeight() + mOffset.y - mThumbHeight / 2) - (mThumbHeight / 2 + mOffset.y);
    }
