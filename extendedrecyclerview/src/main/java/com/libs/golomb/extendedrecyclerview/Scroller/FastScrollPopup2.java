...
public class FastScrollPopup2 {
    ...
    public FastScrollPopup2(Resources resources, FastScrollRecyclerView2 recyclerView) {
     ...
     */
    public Rect updateFastScrollerBounds(FastScrollRecyclerView2 recyclerView, int thumbOffsetY) {
